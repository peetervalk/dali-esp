...
static const DaliCommandInfo s_command_table[] = {
    ...
    CMD(DALI_CMD_UP, "UP", 0x01u, 0x01u, DALI_CMD_FRAME_16BIT, DALI_RESP_NONE, false, false),
    CMD(DALI_CMD_DOWN, "DOWN", 0x02u, 0x02u, DALI_CMD_FRAME_16BIT, DALI_RESP_NONE, false, false),
    CMD(DALI_CMD_STEP_UP, "STEP UP", 0x03u, 0x03u, DALI_CMD_FRAME_16BIT, DALI_RESP_NONE, false, false),
    CMD(DALI_CMD_STEP_DOWN, "STEP DOWN", 0x04u, 0x04u, DALI_CMD_FRAME_16BIT, DALI_RESP_NONE, false, false),
    ...
    CMD(DALI_CMD_STEP_DOWN_AND_OFF, "STEP DOWN AND OFF", 0x07u, 0x07u, DALI_CMD_FRAME_16BIT, DALI_RESP_NONE, false, false),
    CMD(DALI_CMD_ON_AND_STEP_UP, "ON AND STEP UP", 0x08u, 0x08u, DALI_CMD_FRAME_16BIT, DALI_RESP_NONE, false, false),
    CMD(DALI_CMD_ENABLE_DAPC_SEQUENCE, "ENABLE DAPC SEQUENCE", 0x09u, 0x09u, DALI_CMD_FRAME_16BIT, DALI_RESP_NONE, false, false),
    CMD(DALI_CMD_GO_TO_LAST_ACTIVE_LEVEL, "GO TO LAST ACTIVE LEVEL", 0x0Au, 0x0Au, DALI_CMD_FRAME_16BIT, DALI_RESP_NONE, false, false),
    ...
    CMD(DALI_CMD_QUERY_LAMP_FAILURE, "QUERY LAMP FAILURE", 0x92u, 0x92u, DALI_CMD_FRAME_16BIT, DALI_RESP_YES_NO, false, false),
    CMD(DALI_CMD_QUERY_LAMP_POWER_ON, "QUERY LAMP POWER ON", 0x93u, 0x93u, DALI_CMD_FRAME_16BIT, DALI_RESP_YES_NO, false, false),
    CMD(DALI_CMD_QUERY_LIMIT_ERROR, "QUERY LIMIT ERROR", 0x94u, 0x94u, DALI_CMD_FRAME_16BIT, DALI_RESP_YES_NO, false, false),
    CMD(DALI_CMD_QUERY_RESET_STATE, "QUERY RESET STATE", 0x95u, 0x95u, DALI_CMD_FRAME_16BIT, DALI_RESP_YES_NO, false, false),
    CMD(DALI_CMD_QUERY_MISSING_SHORT_ADDRESS, "QUERY MISSING SHORT ADDRESS", 0x96u, 0x96u, DALI_CMD_FRAME_16BIT, DALI_RESP_YES_NO, false, false),
    CMD(DALI_CMD_QUERY_VERSION_NUMBER, "QUERY VERSION NUMBER", 0x97u, 0x97u, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_QUERY_CONTENT_DTR0, "QUERY CONTENT DTR0", 0x98u, 0x98u, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_QUERY_DEVICE_TYPE, "QUERY DEVICE TYPE", 0x99u, 0x99u, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_QUERY_PHYSICAL_MINIMUM, "QUERY PHYSICAL MINIMUM", 0x9Au, 0x9Au, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_QUERY_POWER_FAILURE, "QUERY POWER FAILURE", 0x9Bu, 0x9Bu, DALI_CMD_FRAME_16BIT, DALI_RESP_YES_NO, false, false),
    CMD(DALI_CMD_QUERY_CONTENT_DTR1, "QUERY CONTENT DTR1", 0x9Cu, 0x9Cu, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_QUERY_CONTENT_DTR2, "QUERY CONTENT DTR2", 0x9Du, 0x9Du, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_QUERY_OPERATING_MODE, "QUERY OPERATING MODE", 0x9Eu, 0x9Eu, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_QUERY_LIGHT_SOURCE_TYPE, "QUERY LIGHT SOURCE TYPE", 0x9Fu, 0x9Fu, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_QUERY_ACTUAL_LEVEL, "QUERY ACTUAL LEVEL", 0xA0u, 0xA0u, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, true),
    CMD(DALI_CMD_QUERY_MAX_LEVEL, "QUERY MAX LEVEL", 0xA1u, 0xA1u, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    ...
    CMD(DALI_CMD_QUERY_CONTROL_GEAR_FAILURE, "QUERY CONTROL GEAR FAILURE", 0xAAu, 0xAAu, DALI_CMD_FRAME_16BIT, DALI_RESP_YES_NO, false, false),
    CMD(DALI_CMD_QUERY_SCENE_LEVEL, "QUERY SCENE LEVEL", 0xB0u, 0xBFu, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_QUERY_GROUPS_0_7, "QUERY GROUPS 0-7", 0xC0u, 0xC0u, DALI_CMD_FRAME_16BIT, DALI_RESP_BITSET8, false, false),
    CMD(DALI_CMD_QUERY_GROUPS_8_15, "QUERY GROUPS 8-15", 0xC1u, 0xC1u, DALI_CMD_FRAME_16BIT, DALI_RESP_BITSET8, false, false),
    CMD(DALI_CMD_QUERY_RANDOM_ADDRESS_H, "QUERY RANDOM ADDRESS H", 0xC2u, 0xC2u, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_QUERY_RANDOM_ADDRESS_M, "QUERY RANDOM ADDRESS M", 0xC3u, 0xC3u, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_QUERY_RANDOM_ADDRESS_L, "QUERY RANDOM ADDRESS L", 0xC4u, 0xC4u, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
    CMD(DALI_CMD_READ_MEMORY_LOCATION, "READ MEMORY LOCATION", 0xC5u, 0xC5u, DALI_CMD_FRAME_16BIT, DALI_RESP_MEMORY_BYTE, false, false),
    CMD(DALI_CMD_QUERY_EXTENDED_VERSION_NUMBER, "QUERY EXTENDED VERSION NUMBER", 0xFFu, 0xFFu, DALI_CMD_FRAME_16BIT, DALI_RESP_UINT8, false, false),
...
{
    return (uint8_t)(((addr & 0x3Fu) << 1u) | (selector & 0x01u));
}
...
static uint8_t group_addr_byte(uint8_t group, uint8_t selector)
{
    ...
    return (uint8_t)(0x80u | ((group & 0x0Fu) << 1u) | (selector & 0x01u));
}
...
DaliError dali_build_instance_command(uint8_t addr,
                                      ...
                                      DaliFrame *out)
{
    if (out == NULL || addr >= 64u || !instance_valid(instance)) {
        return DALI_ERR_INVALID;
    }
...
{
    if (frame == NULL || out == NULL || frame->bit_length != 8u) {
        return DALI_ERR_INVALID;
    }
